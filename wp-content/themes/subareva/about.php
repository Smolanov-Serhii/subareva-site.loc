            ...
            <div class="about__container small-container">
                <div class="about__content">
                    <h1 class="about__title section-title">
                        ...
                        <img class="about__title-img" src="<?php echo get_template_directory_uri() . '/img/templates/header/logo.svg'?>" alt="Logo">
                    </h1>
        ...
        <section class="team">
            <div class="team__container small-container">
                <div class="team__title section-title">
                    <h1 class="section-title__main">
                        Команда
                    </h1>
                    <p class="section-title__back">
                        Команда
                    </p>
                </div>
