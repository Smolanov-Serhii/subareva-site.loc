            ...
            <div class="about__container small-container">
                <div class="about__content">
                    ...
                    <div class="about__buttons" data-aos="fade-up" data-aos-delay="1000">
                        <div class="about__button button js-form">
                            <span><?php the_field('nadpis_na_knopke', $post_id)?></span>
                        </div>
                    </div>
                </div>
                <div class="about__sfera">
                    <img src="<?php echo the_field('izobrazhenie_bloka', $post_id)?>" alt="Subareva Clinic">
                </div>
            </div>
        </section>
        <section class="team">
            <div class="team__container small-container">
                ...
                <div class="team__list" data-aos="fade-up" data-aos-delay="700">
                    <?php
                        if( have_rows('sotrudniki', $post_id) ):
                            while( have_rows('sotrudniki') ) : the_row();
                                ...
                                <div class="team__item">
                                    <div class="team__img">
                                        <img class="about__title-img" src="<?php echo $photo ?>" alt="<?php echo $fio ?>">
                                    </div>
                                    <h2 class="team__name">
                                        <?php echo $fio ?>
                                    </h2>
        ...
        <section class="clinic">
            <div class="clinic__container small-container">
                <div class="clinic__title section-title">
                    <h1 class="section-title__main" data-aos="fade-up" data-aos-delay="400">
                        <?php the_field('zagolovok_klinika_slajder', $post_id)?>
                    </h1>
                    <p class="section-title__back" data-aos="fade-up" data-aos-delay="100">
                        <?php the_field('zagolovok_klinika_slajder', $post_id)?>
                    </p>
                            ...
                            <div class="clinic__wrapper swiper-wrapper">
                                ...
                                if( have_rows('slajder', $post_id) ):
                                    while( have_rows('slajder') ) : the_row();
                                        $photo = get_sub_field('izobrazhenie_slajda');
                                        $alt = get_sub_field('opisanie_slajda');
                                        ?>
                                        <div class="swiper-slide clinic__slider-item fresco" href="<?php echo $photo ?>">
                                            <img class="about__title-img swiper-slide-image" src="<?php echo $photo ?>" alt="<?php echo $alt ?>">
                                        </div>
                                    <?php
                                    endwhile;
                                endif;
